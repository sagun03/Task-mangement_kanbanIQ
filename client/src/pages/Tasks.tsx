  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const taskData: TaskFormData = {
        ...
        assignedBy: user?.userId || '', // Set assignedBy as current user
        status: status, // Convert to kebab-case
        createdBy: user?.userId || '', // Set creator as current user
      ...
      // After successful creation, navigate to the board view
